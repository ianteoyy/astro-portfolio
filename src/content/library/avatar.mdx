...
title: "UserAvatar"
language: "Vue"
thumbnail: "../../assets/images/library/avatar/thumbnail.png"
publishDate: "2023-09-20"
---

import UserAvatar from "../../components/UserAvatar.vue";
import { Image } from "astro:assets";
import mihawkRabbit from "../../assets/images/library/avatar/mihawk-rabbit.png";
...
The promise cancelling feature, specifically, was new to me when I was using this library. It wouldn't have been hard to implement it using fetch but to be honest, I didn't know about it until I used this library! Something about standing on the shoulders of giants, I guess.
